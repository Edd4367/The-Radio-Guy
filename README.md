...
Sections
Hero — artist name, tagline, mascot artwork, "Listen now" CTA.
About — short bio and quick stats.
Music — embedded Spotify player for the Musical Theory album.
Listen everywhere — links to Spotify, YouTube and Instagram.
Footer — repeated social links.
Links used
...
Fonts: Bebas Neue and Space Mono via Google Fonts.
